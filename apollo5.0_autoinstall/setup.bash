...
export PYTHONPATH=/apollo/bazel-bin/cyber/py_wrapper:/apollo/cyber/python:/apollo/modules/teleop/common:/usr/local/lib/python2.7/dist-packages:/apollo/py_proto:/apollo/modules/tools:/apollo/bazel-bin/cyber/py_wrapper:/apollo/cyber/python:/apollo/bazel-bin/cyber/py_wrapper:/apollo/cyber/python:
